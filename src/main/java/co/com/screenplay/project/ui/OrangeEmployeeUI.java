...
public class OrangeEmployeeUI {
    ...
    public static final Target SELECT_VACANCY = Target.the("Vacancy").locatedBy("//div[@role='listbox']//span[text()='{0}']");
    ...
    public static final Target UPLOAD_FILE = Target.the("Input file").locatedBy("//input[@type='file']");
    ...
    public static final Target SHORT_LIST_BTN = Target.the("Add button").locatedBy("//button[normalize-space()='Shortlist']");
}
